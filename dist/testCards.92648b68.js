...
},{"../data/card-issuers.json":"data/card-issuers.json"}],"scripts/testCards.js":[function(require,module,exports) {
"use strict";
...
var CARD_GALLERY = document.querySelector('.card-gallery__grid-container');
function getCardIssuers() {
  var issuers = [];
  var _iterator = _createForOfIteratorHelper(_issuerObjects.CARD_ISSUERS),
    _step;
  try {
    for (_iterator.s(); !(_step = _iterator.n()).done;) {
      var cardIssuer = _step.value;
      issuers.push({
...
function createIssuerCard(issuer, parent) {
  var displayCard = (0, _helpers.appendElement)(parent, 'div', 'card-gallery__issuer-card');
  (0, _helpers.appendElement)(displayCard, 'h3', 'card-gallery__subheading', issuer.name);
  var _iterator2 = _createForOfIteratorHelper(issuer.testCards),
    _step2;
  try {
    for (_iterator2.s(); !(_step2 = _iterator2.n()).done;) {
      var cardNumber = _step2.value;
      var cardNumberField = (0, _helpers.appendElement)(displayCard, 'div', 'card-gallery__card-info');
      var cardNumberText = (0, _helpers.appendElement)(cardNumberField, 'p', 'card-gallery__card-number', cardNumber);
      var copyButton = (0, _helpers.appendElement)(cardNumberField, 'button', 'card-gallery__copy-button', 'Copy');
...
function copyTarget() {
  var targetText = this.previousElementSibling.innerText;
  navigator.clipboard.writeText(targetText);
  alert("Copied the card number: ".concat(targetText));
}
var _iterator3 = _createForOfIteratorHelper(getCardIssuers()),
  _step3;
try {
  for (_iterator3.s(); !(_step3 = _iterator3.n()).done;) {
    var issuer = _step3.value;
...
},{}]},{},["node_modules/parcel-bundler/src/builtins/hmr-runtime.js","scripts/testCards.js"], null)
//# sourceMappingURL=/testCards.92648b68.js.map